...
public class UnderGraduationDetails {
    ...
    public float getNoOfStandingArrears() {
        return noOfStandingArrears;
    }

    public void setNoOfStandingArrears(float noOfStandingArrears) {
        this.noOfStandingArrears = noOfStandingArrears;
    }

    public String getArrearDetails() {
        return arrearDetails;
    }

    public void setArrearDetails(String arrearDetails) {
